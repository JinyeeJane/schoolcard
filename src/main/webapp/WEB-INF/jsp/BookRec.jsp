	...
	<div class="row  container-fluid">
		<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
			...
			<div class="navbar-nav col-sm-10 row">
				...
				</a> <a class="nav-item nav-link" href="<%=basePath%>stuLogin/bookRec">推荐系統</a> <a
					class="nav-item nav-link" href="#">贫困生预测</a>
			</div>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="card  col-3 border border-dark"
				...
				<img src="<%=nginx.getString("wordcloud")%>${sessionScope.imgId}" onerror="javascript:this.src='<c:url value="/resources/img/error.bmp"/>'" alt="词云" class="card-img-top">
				<div class="card-body">
					<h4 align="center">
			...
			<div class="col-9">
				...
				<div class="row">
					<table class="table">
						<tbody>
							<tr>
								<th scope="row" bgcolor="#000000" class="rounded"><font color="white">我借过的书</font></th>
							</tr>
							<tr>
								<td>Jacob</td>
								<td>Thornton</td>
